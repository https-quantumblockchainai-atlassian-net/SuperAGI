...
:- ensure_loaded('/var/lib/myfrdcsa/collaborative/git/jason/examples/sentinel-adapter/jason_sentinel_helper.pl').
...
%% :- consult('/var/lib/myfrdcsa/codebases/minor/agentspeak-frdcsa/jason/environments/sentinel/sentinel.pl').

prolog_consult(File) :-
	consult(File).

:- consult('/var/lib/myfrdcsa/codebases/minor/formalog-pengines/formalog_pengines.pl').
:- start_agent(jasonSentinel).
...
%% /var/lib/myfrdcsa/collaborative/git/jason/examples/sentinel-adapter/src/java/SentinelAdapterEnv.java
