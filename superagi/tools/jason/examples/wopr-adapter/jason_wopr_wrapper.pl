...
:- ensure_loaded('/var/lib/myfrdcsa/collaborative/git/jason/examples/wopr-adapter/jason_wopr_helper.pl').
...
%% :- consult('/var/lib/myfrdcsa/codebases/minor/agentspeak-frdcsa/jason/environments/wopr/wopr.pl').

prolog_consult(File) :-
	consult(File).

:- consult('/var/lib/myfrdcsa/codebases/minor/formalog-pengines/formalog_pengines.pl').
:- start_agent(jasonWOPR).
...
%% /var/lib/myfrdcsa/collaborative/git/jason/examples/wopr-adapter/src/java/WOPRAdapterEnv.java
