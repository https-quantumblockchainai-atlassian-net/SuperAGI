...
:- ensure_loaded('/var/lib/myfrdcsa/collaborative/git/jason/examples/metaplanner-adapter/jason_metaplanner_helper.pl').

isa(metaplanner,actor).
...
%% /var/lib/myfrdcsa/collaborative/git/jason/examples/metaplanner-adapter/src/java/MetaplannerAdapterEnv.java
