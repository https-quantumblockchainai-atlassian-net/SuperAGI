...
:- ensure_loaded('/var/lib/myfrdcsa/collaborative/git/jason/examples/python-adapter/jason_python_helper.pl').
...
%% :- consult('/var/lib/myfrdcsa/codebases/minor/python-assistant/jason/environments/python/python.pl').

prolog_consult(File) :-
	consult(File).

:- consult('/var/lib/myfrdcsa/codebases/minor/formalog-pengines/formalog_pengines.pl').
:- start_agent(jasonPython).
...
%% /var/lib/myfrdcsa/collaborative/git/jason/examples/python-adapter/src/java/PythonAdapterEnv.java
