...
:- ensure_loaded('/var/lib/myfrdcsa/collaborative/git/jason/examples/manager-adapter/jason_manager_helper.pl').
...
%% :- consult('/var/lib/myfrdcsa/codebases/minor/manager-assistant/jason/environments/manager/manager.pl').

prolog_consult(File) :-
	consult(File).

:- consult('/var/lib/myfrdcsa/codebases/minor/formalog-pengines/formalog_pengines.pl').
:- start_agent(jasonManager).
...
%% /var/lib/myfrdcsa/collaborative/git/jason/examples/manager-adapter/src/java/ManagerAdapterEnv.java
